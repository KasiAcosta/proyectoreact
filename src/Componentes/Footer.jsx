    ...
    return (
        <footer className="z-depth-5" style={styles.footer}>
          <section  style={styles.sec1}>
           ...
           <div >
           <a target="_blank" href="https://www.linkedin.com/in/acostacasandra/">
            <LinkedInIcon style={styles.link} />
           </a>
           <a target="_blank" href="https://github.com/KasiAcosta"> 
            <GitHubIcon style={styles.link} />
            </a>
            </div>
            <h4 style={styles.h4} >Desarrollado por Kasi Acosta</h4>
            </section>
        </footer>
    )
